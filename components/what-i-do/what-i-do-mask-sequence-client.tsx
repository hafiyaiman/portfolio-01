...
interface WhatIDoMaskSequenceClientProps {
  intro: ReactNode;
  list: ReactNode;
  fallbackContent: ReactNode;
}

export function WhatIDoMaskSequenceClient({
  intro,
  list,
  fallbackContent,
}: WhatIDoMaskSequenceClientProps) {
      ...
      >
        ...
        <div ref={overlayRef} className="absolute inset-0 z-20">
          ...
          >
            ...
            >
              <div className="bg-brand h-full w-full overflow-hidden">
