...
interface MorphFooterRevealClientProps {
...
export function MorphFooterRevealClient({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 bg-background pt-24 sm:pt-28">
        {footerContent}
      </div>
    </section>
  );
